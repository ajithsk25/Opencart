...
class ControllerExtensionModuleZynkPricelists extends Controller
{
    var $products;
    ...
    public function UploadPricelists(&$pricelists, $truncate = false)
    {
        $this->_startup();
        ...
        if ($truncate) {
            echo("</br></br><b>Clear down all the product special prices.</b></br>");

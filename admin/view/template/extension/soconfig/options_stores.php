...
<ul class="nav nav-tabs main_tabs_vertical">
    ...
    <?php endif;?>
    <li><a href="#tab-marketplace<?php echo $store['store_id']; ?>" data-toggle="tab"><i class="fa fa-shopping-cart"></i> MarketPlace<label class="label label-danger label-new">New</label></a></li>
...
<div class="tab-content main_content_vertical col-sm-10">
                ...
                <div class="so-panel">
                    ...
                    <div class="panel-container">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-5">
                                <button onclick="buttonApplyColor();" class="btn btn-primary" type="button" <?php  if ($scsscompile) {
                                    echo "disabled='disabled'";
                                                                                                            } ?>><i class="fa fa-compress" aria-hidden="true"></i> Compile CSS</button>
                            </div>
    ...
    <!-------------------------------------Tab Tab Our Services-->
    <div class="tab-pane" id="tab-marketplace<?php echo $store['store_id']; ?>">
         <ul class="nav nav-tabs  main_tabs_2">
            <li class="active"><a href="#tab-ourthemes-layout1-<?php echo $store['store_id']; ?>" class="selected" data-toggle="tab">Our Themes</a></li>
            <li><a href="#tab-ourthemes-layout2-<?php echo $store['store_id']; ?>" data-toggle="tab">Our Packages</a></li>
            <li><a href="#tab-ourservices-layout3-<?php echo $store['store_id']; ?>" data-toggle="tab">Our Services</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active wrapper-tabcategory" id="tab-ourthemes-layout1-<?php echo $store['store_id']; ?>">
                <div class="so-panel">
                    <iframe style="border: 1px solid #ccc" src="http://opencartworks.com/html/themes.html" height="600" width="100%"></iframe>
                </div>
            </div>
            
             <!--subtabs: labels -->
            <div id="tab-ourthemes-layout2-<?php echo $store['store_id']; ?>" class="tab-pane">
                <div class="so-panel">
                    <iframe style="border: 1px solid #ccc" src="http://opencartworks.com/html/packages.html" height="600" width="100%"></iframe>
                </div>
            </div>

            <!--subtabs: product page -->
            <div id="tab-ourservices-layout3-<?php echo $store['store_id']; ?>" class="tab-pane">
                <div class="so-panel">
                    <iframe style="border: 1px solid #ccc" src="http://opencartworks.com/html/services.html" height="600" width="100%"></iframe>
                </div>
            </div>
           
        </div>
    </div>
    <!-------------------------------------End Tab Our Services-->

...
class Braintree_TransactionSearch
{
    ...
    static function creditCardUniqueIdentifier()
    {
        return new Braintree_TextNode('credit_card_unique_identifier');
    }
    ...
    static function paymentInstrumentType()
    {
        return new Braintree_MultipleValueNode('paymentInstrumentType');
    }
    ...
    {
        return new Braintree_TextNode('paypal_authorization_id');
    }
    static function paypalPayerEmail()
    {
        return new Braintree_TextNode('paypal_payer_email');
    }
    static function paypalPaymentId()
    {
        return new Braintree_TextNode('paypal_payment_id');
    }
    ...
    {
        return new Braintree_MultipleValueNode('user');
    }
